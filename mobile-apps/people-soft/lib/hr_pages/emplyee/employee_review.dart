...
class EmployeeReview extends StatefulWidget {
  ...
  @override
  State<EmployeeReview> createState() => _EmployeeReviewState();
}

class _EmployeeReviewState extends State<EmployeeReview> {
  ...
  Future<ReviewModel?> _fetchReview() async {
    final uri = Uri.parse(
      '${getBaseUrl()}/api/employee-reviews/${widget.employeeId}?month=$_selectedMonth',
    );
  ...
  Future<void> _submitGrades(ReviewModel review) async {
    ...
    final uri = Uri.parse(
      '${getBaseUrl()}/api/employee-reviews/${review.employeeId}/grade?month=$_selectedMonth',
    );
...
class ReviewModel {
  final String employeeId; // ✅ CHANGED: internId → employeeId
  final String employeeName; // ✅ CHANGED: internName → employeeName
  final String team;
  final String? date;
  final bool isGraded;
  ...
  factory ReviewModel.fromJson(Map<String, dynamic> json) {
    return ReviewModel(
      employeeId: json['employeeId'] ?? '', // ✅ CHANGED field name
      employeeName: json['employeeName'] ?? '', // ✅ CHANGED field name
      team: json['team'] ?? '',
      date: json['date'],
