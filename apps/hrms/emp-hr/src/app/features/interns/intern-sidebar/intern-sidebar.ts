...
import { Home01Icon, FileDownloadIcon, NoteEditIcon, Calendar01Icon, Chat01Icon, LogoutIcon, CancelCircleIcon } from '@hugeicons/core-free-icons';
...
@Component({
  ...
  <aside class="action-sidebar">
    ...
    <button routerLink="/interns" [queryParams]="{tab: 'rejected'}" class="sidebar-action-item" [class.active]="activeTab === 'rejected'" title="Rejected Applications">
      <div class="action-icon-circle">
