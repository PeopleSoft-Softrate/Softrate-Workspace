        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  (a['name'] ?? a['internId']).toString().replaceFirstMapped(
                        RegExp(r'^\w'),
      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              GestureDetector(
                onTap: () => _launchPhoneCall(a['contact']?.toString()),
                child: Container(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (mounted) {
                        setState(() {
                          _attendanceFuture =
                              TodayAttendanceService.fetchTodayAttendance();
                        });
                      }
                    },
